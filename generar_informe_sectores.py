#!/usr/bin/env python3
"""
Generador de Informe con Diagramas de Sectores
==============================================

Este script genera un informe detallado donde:
- Cada asignatura tiene su propia subsección
- Incluye una tabla de resultados con números y porcentajes
- Genera un diagrama de sectores (gráfico circular) por asignatura
- Documento largo y detallado ideal para análisis pormenorizado
...
from config import (
    ...
    DIRECTORIO_OUTPUT, SUBDIRECTORIO_GRAFICOS, ARCHIVO_LATEX_SECTORES,
...
"""
    ...
    archivo_completo = os.path.join(DIRECTORIO_OUTPUT, ARCHIVO_LATEX_SECTORES)
